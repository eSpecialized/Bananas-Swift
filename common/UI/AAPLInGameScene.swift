...
class AAPLInGameScene: SKScene {
    ...
    fileprivate var timeLabelValue: SKLabelNode
    fileprivate var timeLabelValueShadow: SKLabelNode!
    fileprivate var scoreLabel: SKLabelNode
    fileprivate var scoreLabelShadow: SKLabelNode!
    fileprivate var timeLabel: SKLabelNode
    fileprivate var timeLabelShadow: SKLabelNode!
    fileprivate var menuNode: AAPLMainMenu?
    fileprivate var pauseNode: AAPLPauseMenu?
    fileprivate var postGameNode: AAPLPostGameMenu?
    ...
    fileprivate func willSetGameState(_ newState: AAPLGameState) {
    ...
    fileprivate func hideInGameUI(_ hide: Bool) {
    ...
    class func dropShadowOnLabel(_ frontLabel: SKLabelNode) -> SKLabelNode {
