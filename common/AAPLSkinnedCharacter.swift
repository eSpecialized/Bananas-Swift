...
@objc class AAPLSkinnedCharacter: SCNNode, CAAnimationDelegate {
    ...
    class func loadAnimationNamed(_ animationName: String, fromSceneNamed sceneName: String) -> CAAnimation? {
        ...
        #if os(OSX)
//            let options: [String: AnyObject] = [SCNSceneSource.LoadingOption.convertToYUp.rawValue: true as AnyObject]
//        let boolVal = true    
